...
- `hiring_interaction_recursion_summary_redacted.json`: Section 8 working-model recursion / interaction-aware check.
- `hiring_measurement_error_summary_redacted.json`: Section 8 sensitive-attribute error sensitivity.
